        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i>
                <b className="purple"> C++, Javascript , React , tailwind,  Bootstrap , C++ and Java</b>
              </i>
              <br />
              <br />
          ...
          <Col md={4} className="myAvtar">
            <Tilt>
              <img style={{borderRadius:"50%" , height:"350px", width:"300px"}} src={myImg} className="img-fluid" alt="avatar" />
            </Tilt>
          </Col>
        </Row>
        <Row>
